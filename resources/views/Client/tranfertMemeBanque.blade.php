...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; ">
            ...
            <form action="{{ route('transactions.memeBanque') }}" method="post" style="display: flex; flex-direction: column; align-items: center;">
                @csrf
                @method('POST')
                <label for="account_number" style="margin-bottom: 10px;">Veuillez saisir le numéro du compte bancaire du destinataire </label>
                <br>
                <input type="text" id="account_number" name="account_number" required style="width: 300px; padding: 10px; border: 1px solid #ccc; border-radius: 5px; margin-bottom: 20px; box-sizing: border-box;">
