                ...
                <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <p class="lead">
                                Entrez vos information pour pouvoir changer de mot de passe
                            </p>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                <div class="m-sm-3">
                                    <form action="{{ route('auth.forgotPasswordValider') }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="numeroClient" />
                                            @error('numeroClient')
                                            <p class="alert alert-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Numero Carte d'identite</label>
                                            <input class="form-control form-control-lg" type="number" name="numeroCI" />
                                            @error('password')
                                            <p class="alert alert-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                        ...
                        <div class="text-center mb-3">
                            ...
                            <br>
                            <a href="{{ route('auth.login') }}">&larr; Retour vers la page de connexion</a>
