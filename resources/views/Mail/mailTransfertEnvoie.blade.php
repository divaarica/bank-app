...
<body>
    ...
    <h4>Vous avez transferer de l'argent a  {{ $transactionData['prenom2'] }} {{ $transactionData['nom2'] }}</h4>
    <h4>Voici Les informations :</h4>
    <ul>
        <p>Type de transaction: {{ $transactionData['type'] }}</p>
        <p>Code transaction: {{ $transactionData['code'] }}</p>
        <p>Montant transferer: {{ $transactionData['montant'] }} FCFA</p>
        <p>Numero de votre compte: {{ $transactionData['compte'] }}</p>
        <p>Numero du compte destinataire: {{ $transactionData['compte2'] }}</p>
