                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <form action="{{ route('comptes.openCourant', ['client' => $c->id, 'pack' => $c->comptes->first()->pack ]) }}" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir ouvrir un compte epargne pour ce client? ?');">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-info"> Ouvrir compte Epargne</button>
                            </form>
                            @else
                            <form action="{{ route('comptes.openEpargne', ['client' => $c->id, 'pack' => $c->comptes->first()->pack ]) }}" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir ouvrir un compte courant pour ce client? ?');">
                                @csrf
                                @method('PUT')
