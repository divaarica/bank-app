		...
		<div class="container ">
			...
			<div class="row">
				<div class="col-md-5 p-4" style="background-color: rgba(245, 158, 108, 0.8);">
					...
					<h4>Debiter des comptes en fonction du type de compte </h3>
						<br>
						<h6 class="text-danger">Attention tout les comptes seront Debite du montant de leur type de pack</h6>
						<br>
						<br>
